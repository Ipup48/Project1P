        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create New About Content</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.new-about.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="section" name="section" required>
                                ...
                                <option value="general_info" {{ old('section') == 'general_info' ? 'selected' : '' }}>General Info</option>
                                <option value="careers" {{ old('section') == 'careers' ? 'selected' : '' }}>Careers</option>
                                <option value="objectives" {{ old('section') == 'objectives' ? 'selected' : '' }}>Objectives</option>
                                <option value="outcomes" {{ old('section') == 'outcomes' ? 'selected' : '' }}>Outcomes</option>
                        ...
                        <button type="submit" class="btn btn-primary">Create About Content</button>
                    </form>
                </div>
            </div>
        </div>
